						...
						<div id="main" class="eightcol first clearfix" role="main">
							...
							<?php if (is_category()) { ?>
								<h1 class="archive-title h2">
									<span><?php _e( 'Posts Categorized:', 'webdraftertheme' ); ?></span> <?php single_cat_title(); ?>
								</h1>

							<?php } elseif (is_tag()) { ?>
								<h1 class="archive-title h2">
									<span><?php _e( 'Posts Tagged:', 'webdraftertheme' ); ?></span> <?php single_tag_title(); ?>
								</h1>
							...
							?>
								<h1 class="archive-title h2">
									...
									<span><?php _e( 'Posts By:', 'webdraftertheme' ); ?></span> <?php the_author_meta('display_name', $author_id); ?>

								</h1>
							<?php } elseif (is_day()) { ?>
								<h1 class="archive-title h2">
									<span><?php _e( 'Daily Archives:', 'webdraftertheme' ); ?></span> <?php the_time('l, F j, Y'); ?>
								</h1>

							<?php } elseif (is_month()) { ?>
									<h1 class="archive-title h2">
										<span><?php _e( 'Monthly Archives:', 'webdraftertheme' ); ?></span> <?php the_time('F Y'); ?>
									</h1>

							<?php } elseif (is_year()) { ?>
									<h1 class="archive-title h2">
										<span><?php _e( 'Yearly Archives:', 'webdraftertheme' ); ?></span> <?php the_time('Y'); ?>
									</h1>
							<?php } ?>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry clearfix">
										...
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the archive.php template.', 'webdraftertheme' ); ?></p>
										</footer>
									</article>
